...
async def amireallyalive(awake):
   ...
   if PHOTO:
     ...
     ALIVE_MESSAGE += f"💠 [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FSURYAPLAYZUSERBOT%2FLEGEN-BOT&template=https%3A%2F%2Fgithub.com%2FSURYAPLAYZUSERBOT%2FLEGEND-ROBOT) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/legendxop/SURYAPLAYZUSERBOT)  💠\n"   
     await awake.delete() 
