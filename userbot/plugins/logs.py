...
async def inline_id_handler(event: events.InlineQuery.Event):
    ...
    if not event.query.user_id == me.id:
        resultm = builder.article(title="me not your bot",description="Mind Your Business",text="Hey U Must Use https://github.com/legendx22/SURYAPLAYZUSERBOT ",buttons=[[Button.switch_inline("Search Again", query="logs", same_peer=True)],], )
